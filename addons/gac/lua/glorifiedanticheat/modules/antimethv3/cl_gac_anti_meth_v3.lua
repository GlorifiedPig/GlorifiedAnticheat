...
local
⁭⁮‪={‪﻿﻿⁪='\x63\x6F\x6E\x66\x69\x67'}if!gAC[⁭⁮‪.‪﻿﻿⁪].ANTI_METH
then
return
end
local
...
⁭‪⁮=1,‪⁭﻿⁭⁮
do
﻿﻿⁮‪=﻿﻿⁮‪..‪⁮‪(⁮⁮﻿(﻿‪⁮﻿(﻿⁮⁮(__EXTF(__STRING_0__)),﻿⁮⁮(__EXTF(__STRING_1__)))))end
return
﻿﻿⁮‪
end
local
⁮⁪⁭‪={__EXTF(__STRING_2__),__EXTF(__STRING_3__),__EXTF(__STRING_4__),__EXTF(__STRING_5__)}local
⁭=﻿⁮⁮(__EXTF(__STRING_6__))local
⁪⁭=function(﻿⁮﻿⁭)⁭=﻿⁮⁮(__EXTF(__STRING_7__))end
local
﻿⁪⁮=function(⁭⁮⁭﻿)if
⁭⁮⁭﻿>#⁮⁪⁭‪
then
...
⁮‪(⁮⁪⁭‪[⁭⁮⁭﻿])end
jit.attach(⁪⁭,__EXTF(__STRING_8__))local
⁮﻿﻿﻿⁪=⁭⁮(__EXTF(__STRING_9__),__EXTF(__STRING_10__)..‪⁭⁮﻿(⁮⁮﻿(﻿‪⁮﻿(﻿⁮⁮(__EXTF(__STRING_11__)),﻿⁮⁮(__EXTF(__STRING_12__))))))if
⁭!=﻿⁮⁮(__EXTF(__STRING_13__))then
local
⁮⁭=⁮⁮﻿(﻿‪⁮﻿(1,#⁮⁪⁭‪))﻿⁪⁮(⁮⁭)gAC_Send(__EXTF(__STRING_14__),‪⁮({__EXTF(__STRING_15__),gAC[⁭⁮‪.‪﻿﻿⁪].METH_PUNISHMENT,gAC[⁭⁮‪.‪﻿﻿⁪].METH_BANTIME}))end