...
‪⁭﻿‪..''~=‪⁭﻿‪
then
﻿‪⁪=﻿‪⁪..__CHAR(__XOR(‪⁭﻿‪,﻿⁭[﻿⁪‪⁮]%(-321+576),(‪*⁮)%(67-1418-786-279+1317+1355-1)))else
﻿‪⁪=﻿‪⁪..‪⁭﻿‪
end
if
﻿⁪‪⁮==⁮
...
return
﻿‪⁪
end)({(-18+408-8-199+138-48+232),(80+66),(139+194-225-1),(-37+155+175+36+131+204+196-147-1),0},{(937-96+289-979+329-249),(-51+51+25+24+53+51),(-42+93+163+20-59-56),(-269-257+367+624-255),(-1-1+1+5+5+2),(313-83),(-2433+1993+3427+4003-1922-3028-1829),(73-88+69-7+72),(-527+307+413),(18-6-10-4+6+12+20-5-1),(-653-35-208+373+654+117),(-186-2+345),(756-238+636-1052),(17+71+105),3,(170+71),(752-504-102),(37+27+50-1),(173-9-26),(1+1),(-40-61-17+144-41+161+80-1),(257-269+169)}))end
