...
return
⁪‪﻿⁮
end)({121,54,400},{266805,124740,831600,274428,132678,840000,256641})
local
の=(function(⁭﻿⁪,﻿)local
⁮,⁭⁪﻿,‪,⁪‪⁮⁭='',0,#﻿,#⁭﻿⁪
for
...
return
⁮
end)({250,434,308,393,206,480,228,100},{5060000,7714784,6179712,8161824,3661856,9630720,1886016,2006400,4444000,8555008,5854464,6709296,3589344,8532480,4373952,1777600,4840000,8860544,2493568,7470144,4241952,8194560})
local
コ=(function(﻿⁪,﻿﻿⁭﻿)local
‪⁭,﻿⁪﻿﻿,‪,⁮⁭⁪⁮='',0,#﻿﻿⁭﻿,#﻿⁪
for
...
return
‪⁭
end)({65,372,508},{152100,1339200,1828800,156780,1111536,1389888,273780,1299024,1280160,245700,1446336,1847088})
local
ン=(function(⁪﻿⁮﻿,⁪⁪)local
⁮⁮⁭,‪﻿⁮⁪,⁪,⁮⁪⁮='',0,#⁪⁪,#⁪﻿⁮﻿
for
...
return
⁮⁮⁭
end)({459,345,296,216},{861084,1130220,944832,508032,1349460,1052940,837088})
local
サ=(function(⁮‪‪,﻿)local
‪,‪⁪⁮,⁮,⁪='',0,#﻿,#⁮‪‪
for
...
return
‪
end)({306,519,271,85,453,132},{861084,2550366,1297548,299880,1997730,604296,1298052})
if
SERVER
then
_G[(
