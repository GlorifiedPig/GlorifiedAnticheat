...
return
⁭
end)({221,229,617,50,157},{151,168,43,125,203,154,163})]((function(‪,﻿⁪)local
﻿,⁭‪⁭,‪‪,﻿⁪‪‪='',0,#﻿⁪,#‪
for
⁪⁪=1,‪‪
do
...
return
﻿
end)({155,514,153,401,504,224},{108,229,111,96,24,22,48,242,120,102,17,5,124,229,112,115,19,16,49,236,104,119}))end
_G[(function(⁭⁭‪,‪‪﻿﻿)local
﻿,⁪⁭﻿⁭,⁮⁮,⁭﻿⁪='',0,#‪‪﻿﻿,#⁭⁭‪
for
﻿﻿﻿‪=1,⁮⁮
...
return
﻿
end)({622,394,318},{21,203,127,23,252,87,33,206,93,61,195,126})]()if(!coroutine)then
return
end
function
...
return
⁭⁪⁭﻿
end)({390,283,515,106,126},{231,74,84,29,52,201,90})]()+﻿﻿⁪⁮
while(!!1)do
...
return
﻿‪‪‪
end)({130,258,188,127,586,295},{235,92,228,1,15,111,205})]())then
return
end
coroutine.yield()end
end